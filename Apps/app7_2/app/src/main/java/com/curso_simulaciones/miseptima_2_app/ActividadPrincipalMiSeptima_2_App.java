...
public class ActividadPrincipalMiSeptima_2_App extends Activity implements Runnable {
    ...
    /**
     * Detener el hilo al destruir la Activity para evitar fugas
     */
    @Override
    ...
    private LinearLayout crearGui() {
        ...
        // combinación de flags de gravedad
        linear_principal.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.FILL_VERTICAL);
        linear_principal.setBackgroundColor(Color.rgb(250, 150, 50));

        /* pegar el objeto tipo Pizarra (PizarraDibujo) */
        // parámetro de pegada
    ...
    private void cambiarEstadosEscenaPizarra(float tiempo) {
        ...
        /*
         ...
         rota alrededor de su eje con velocidad angular W=50
         */
