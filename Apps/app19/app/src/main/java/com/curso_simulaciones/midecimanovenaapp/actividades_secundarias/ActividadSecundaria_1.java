...
public class ActividadSecundaria_1 extends Activity {
    ...
    private LinearLayout crearGUI() {
        ...
        linearPrincipal.setPadding(5, 5, 5, 5);
        ...
        linearImagenPrincipal.setWeightSum(Gravity.CENTER);
        linearImagenPrincipal.setGravity(Gravity.CENTER);
        linearImagenPrincipal.setWeightSum(90.0f);
    ...
    protected void onPause() {
        ...
        AlmacenDatosRAM.nombreImagen1 = nombre;
