package com.example.midecimaapp; //
...
import com.example.midecimaapp.objetos_laboratorio.CuerpoRectangular;
import com.example.midecimaapp.objetos_laboratorio.Polea;
import com.example.midecimaapp.objetos_laboratorio.Rueda;
import com.example.midecimaapp.vista.CR;
import com.example.midecimaapp.vista.Pizarra;

/**
 * Actividad principal organizada. No se cambió la lógica original,
 * solo se añadieron imports y se corrigió formato/sintaxis.
 */
public class ActividadPrincipalMiDecimaApp extends Activity implements Runnable {
    ...
    private void crearObjetosLaboratorio() {
        ...
        // agregarla al arreglo de poleas
        poleas[0] = polea_1;
