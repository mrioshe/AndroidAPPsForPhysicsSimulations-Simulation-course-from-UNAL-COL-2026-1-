package com.curso_simulaciones.midecimaprimeraapp; // reemplaza por el paquete real de tu proyecto
...
public class ActividadPrincipalMiDecimaPrimeraApp extends Activity implements Runnable {
    ...
    private LinearLayout crearGui() {
        ...
        // pegar pizarra a linearArriba (se añade con LayoutParams para evitar tamaños 0)
