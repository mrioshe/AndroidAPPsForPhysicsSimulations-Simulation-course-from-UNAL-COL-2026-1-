...
/**
 * Utilidades de conversión entre porcentajes relativos
 * a la "pizarra" y píxeles.
 */
public class CR {
    ...
    public CR() {
        // Constructor por defecto (se mantiene según tu estructura original)
    }
     ...
     * y el alto de la pizarra, la convierte a una longitud en píxeles.
     *
     * @param pcL longitud en porcentaje (0..100)
     * @return longitud en píxeles (referida al menor entre ancho y alto)
     */
    ...
    /**
     * Dada una longitud pxL en píxeles la convierte a porcentaje referido
     * al menor entre el ancho y el alto de la pizarra.
     *
     * @param pxL longitud en píxeles
     * @return longitud en porcentaje (referida al menor entre ancho y alto)
     */
