...
public class Polea {
    ...
    public Polea() {
        this.radio = 20f;
        // Opcional inicializar posiciones (quedó igual que la lógica original)
        this.posicionInicialX = 0f;
        this.posicionInicialY = 0f;
        this.posicionX = 0f;
        this.posicionY = 0f;
    ...
    public void dibujese(Canvas canvas, Paint pincel) {
        ...
        canvas.save();
        // rotar respecto al centro de la polea (grados)
        ...
        for (int i = 0; i < 12; i = i + 1) {
            // rotar de a (i*36) grados respecto al centro, dibujar y deshacer rotación
