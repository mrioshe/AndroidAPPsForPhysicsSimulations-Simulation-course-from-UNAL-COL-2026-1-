...
/**
 * Actividad principal que administra la pizarra y la animación
 * de las poleas. Implementa Runnable para correr el hilo
 * que controla la animación.
 */
public class ActividadPrincipalMiOctavaApp extends Activity implements Runnable {
    ...
    private void crearObjetosLaboratorio() {
        ...
        // polea 6 con su centro en X = 0 e Y = 0.25 de la altura del canvas
        x_c = CR.pcApxX(0);
        y_c = CR.pcApxY(25);
        poleas[5] = new Polea(x_c, y_c, radio);
        poleas[5].setColorPolea(Color.BLACK);

        // polea 7 con su centro en X = 0 e Y = 0.75 de la altura del canvas
        x_c = CR.pcApxX(0);
        y_c = CR.pcApxY(75);
    ...
    /*
     Cambia el estado de los objetos polea y lo comunica a pizarra
     */
