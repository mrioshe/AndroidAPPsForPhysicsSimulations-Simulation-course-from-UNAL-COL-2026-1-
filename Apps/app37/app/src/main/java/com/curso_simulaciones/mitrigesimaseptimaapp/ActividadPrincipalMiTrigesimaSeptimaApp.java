    ...
    private void verificacionPermisos() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.S) {
            ...
            if (hasReadWritePermission != PackageManager.PERMISSION_GRANTED || hasBluetoothScan != PackageManager.PERMISSION_GRANTED) {
                ...
                ActivityCompat.requestPermissions(ActividadPrincipalMiTrigesimaSeptimaApp.this,
                        new String[]{
        ...
        switch (requestCode) {
            case 100:
                if (grantResults.length > 0
                    ...
                    Toast.makeText(ActividadPrincipalMiTrigesimaSeptimaApp.this, "Permiso denegado.", Toast.LENGTH_SHORT).show();
                    finish();
                }
                return;
        }
